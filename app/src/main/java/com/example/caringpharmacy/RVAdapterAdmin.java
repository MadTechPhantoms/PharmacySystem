...
public class RVAdapterAdmin extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    ArrayList<Feedback> list = new ArrayList<>();
    public RVAdapterAdmin(Context ctx)
    {
        this.context = ctx;
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position, Feedback e)
    {
        ...
        vh.txt_option.setOnClickListener(v->
        {
            ...
            popupMenu.inflate(R.menu.option_menu_admin);
